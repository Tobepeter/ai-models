...
interface ImportMetaEnv {
	...
	readonly VITE_OSS_ACCESS_KEY: string // OSS访问密钥ID (仅ak模式需要)
	readonly VITE_OSS_ACCESS_SECRET: string // OSS访问密钥Secret (仅ak模式需要)
	readonly VITE_OSS_ROLE_ARN: string // OSS角色ARN (STS模式需要)
	readonly VITE_OSS_DEPLOY_ENABLE: string // 是否启用OSS部署
}
