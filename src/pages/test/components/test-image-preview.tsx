				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						...
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.portrait}
								notEditable
							/>
						</div>
					</div>
				...
				<CardContent className="space-y-4">
					<div className="flex items-end gap-4">
						...
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.dummyGreen}
								notEditable
								width={160}
								height={120}
							/>
				...
				<CardContent className="space-y-4">
					<div className="flex items-center gap-4">
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.avatarMale}
								notEditable
								size={64}
						...
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.avatarFemale}
								notEditable
								size={64}
								className="rounded-full overflow-hidden"
							/>
						...
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.avatar}
								size={64}
								className="rounded-full overflow-hidden"
								onUpload={handleUpload}
								onDelete={handleDelete}
							...
							<div className="flex items-center gap-2">
								...
								<div className="space-y-1">
									<Button 
										size="sm" 
										variant="outline"
										onClick={() => setControllableUrl(dummy.images.landscape)}
									>
										设置风景图
									</Button>
									<Button 
										size="sm" 
										variant="outline"
										onClick={() => setControllableUrl(dummy.images.dummyPurple)}
									>
										设置紫色图
									</Button>
									<Button 
				...
				<CardContent className="space-y-4">
					<div className="flex items-center gap-4">
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.dummyYellow}
								notEditable
								className="w-32 h-24"
							>
						...
						<div className="space-y-2">
							...
							<ImagePreview
								defaultUrl={dummy.images.dummyPink}
								notEditable
								className="w-32 h-24"
							>
