      ...
      <Card>
        ...
        <CardContent>
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p className="pt-2"><strong>回调函数：</strong></p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><code>onSubmit</code>: 每次提交时触发</li>
              <li><code>onCancel</code>: 取消编辑时触发</li>
              <li><code>onSubmitChange</code>: 只有内容真正变化时才触发</li>
            </ul>

            <p className="pt-2"><strong>特殊功能：</strong></p>
            <ul className="list-disc list-inside space-y-1 ml-4">
              <li><code>allowEmpty={false}</code>: 不允许空值，空值时会回滚到原始内容</li>
              <li><code>maxLength</code>: 字符长度限制，默认15字符</li>
              <li><code>showCharCount</code>: 显示字符计数</li>
              <li><code>noAutoTrim</code>: 禁用自动去除首尾空格</li>
            </ul>
          </div>
        </CardContent>
      </Card>
