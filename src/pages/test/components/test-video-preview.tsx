				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						...
						<div className="space-y-2">
							...
							<VideoPreview
								defaultUrl={dummy.videos.elephants}
								onUpload={handleUpload}
								onDelete={handleDelete}
								onChange={handleChange}
							/>
						...
						<div className="space-y-2">
							...
							<VideoPreview
								defaultUrl={dummy.videos.forBiggerBlazes}
								notEditable
							/>
						</div>
					</div>
				...
				<CardContent className="space-y-4">
					<div className="grid grid-cols-2 md:grid-cols-4 gap-4">
						...
						<div className="space-y-2">
							...
							<VideoPreview
								defaultUrl={dummy.videos.forBiggerFun}
								cover={dummy.images.dummyBlue}
								notEditable
								size={160}
							/>
						</div>
					...
					<div className="grid grid-cols-2 md:grid-cols-3 gap-4">
						...
						<div className="space-y-2">
							...
							<VideoPreview
								defaultUrl={dummy.videos.forBiggerEscapes}
								cover={dummy.images.portrait}
								notEditable
								width={120}
								height={160}
							/>
						...
						<div className="space-y-2">
							...
							<VideoPreview
								defaultUrl={dummy.videos.forBiggerJoyrides}
								cover={dummy.images.square}
								notEditable
								size={160}
							/>
						</div>
							...
							<div className="flex items-center gap-2">
								...
								<div className="space-y-1">
									<Button 
										size="sm" 
										variant="outline"
										onClick={() => setControllableUrl(dummy.videos.bunny)}
									>
										兔子视频
									</Button>
									<Button 
										size="sm" 
										variant="outline"
										onClick={() => setControllableUrl(dummy.videos.elephants)}
									>
										象群视频
									</Button>
									<Button 
										size="sm" 
										variant="outline"
										onClick={() => setControllableUrl(dummy.videos.forBiggerMeltdowns)}
									>
										崩溃视频
									</Button>
									<Button 
