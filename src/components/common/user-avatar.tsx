...
export const UserAvatar = (props: UserAvatarProps) => {
	...
	return (
		<ImagePreview url={src} size={size} aspectRatio="1/1" noEditable={!finialEditable} noPreview={finalNoPreview} loading={loading} className={cn('rounded-full', className)} style={boxStyle}>
			{avatarContent}
		</ImagePreview>
	)
}
