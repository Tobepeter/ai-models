...
export interface GetTestParams {
	/** 错误类型 */
	type?: '400' | '401' | '403' | '404' | '405' | '409' | '413' | '429' | '500' | '503' | 'validation' | 'success'
	/** 自定义错误消息 */
	message?: string
}
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
	admin = {
		 ...
		 */
		usersResetPasswordCreate: (id: string, request: UsersResetPasswordCreatePayload, params: RequestParams = {}) =>
	...
	ai = {
		 ...
		 */
		chatHistoryList: (query: ChatHistoryListParams, params: RequestParams = {}) =>
		 ...
		 */
		chatHistoryDelete: (query: ChatHistoryDeleteParams, params: RequestParams = {}) =>
		 ...
		 */
		v1ChatCompletionsCreate: (query: V1ChatCompletionsCreateParams, request: OpenAIChatCompletionRequest, params: RequestParams = {}) =>
		 ...
		 */
		v1ImagesGenerationsCreate: (query: V1ImagesGenerationsCreateParams, request: V1ImagesGenerationsCreatePayload, params: RequestParams = {}) =>
	...
	crud = {
		 ...
		 * @request PUT:/crud/{id}
		 */
		update: (id: string, request: CrudUpdateRequest, params: RequestParams = {}) =>
	...
	test = {
		 ...
		 */
		errBusinessDetail: (type: 'validation' | 'auth' | 'permission' | 'quota' | 'maintenance', params: RequestParams = {}) =>
		 ...
		 */
		errCodeDetail: (code: '400' | '401' | '403' | '404' | '405' | '409' | '413' | '429' | '500' | '503', params: RequestParams = {}) =>
		 ...
		 */
		errNetworkDetail: (type: 'timeout' | 'connection' | 'dns' | 'ssl', params: RequestParams = {}) =>
	...
	todos = {
		 ...
		 */
		updateTodoPositions: (request: TodoPositionUpdateRequest, params: RequestParams = {}) =>
		 ...
		 */
		updateTodo: (id: string, request: TodoUpdateRequest, params: RequestParams = {}) =>
	...
	users = {
		 ...
		 */
		changePasswordCreate: (request: ChangePasswordRequest, params: RequestParams = {}) =>
